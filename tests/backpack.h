    ...
    public:
        static void execute()
        {
            ...
            while (!window.shouldClose())
            {
                ...
                glm::vec3 lightColor(0.3f, 0.0f, 0.0f);      // 光源颜色
                glm::vec3 lightAmbient(0.2f, 0.2f, 0.2f);    // 环境光
                glm::vec3 lightDiffuse = lightColor * 0.5f;  // 漫反射光
                glm::vec3 lightSpecular = lightColor * 1.0f; // 镜面反射光
